...
const ELEMENT_DATA: performanceData[] = [
  {
    id: 1,
    imagePath: 'assets/images/product/product-1.webp',
    pname: 'Anta Air Force 1 NDESTRUKT',
    category: 'Backetball Sport',
    progress: 78.5,
    sales: 3.9,
    status: 'low',
  },
  {
    id: 2,
    imagePath: 'assets/images/product/product-13.webp',
    pname: 'Nike Blazer Low 77 Vintage',
  ...
  {
    id: 3,
    imagePath: 'assets/images/product/product-14.webp',
    pname: 'XTER Court Royale',
    category: 'Tennis Sport',
    progress: 25,
    sales: 3.8,
    status: 'high',
  },
